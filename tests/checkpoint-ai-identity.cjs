...
const hintContainerStart = idx.lastIndexOf('v-if="quickInputSubjectRole === \'both\'" class="quick-chat-names-v2"', hintIdx)
const hintContainerEnd = idx.indexOf('</view>', hintIdx)
check('hint is inside v-if="both"', hintIdx > 0 && hintContainerStart > 0 && hintContainerEnd > hintIdx)
