...
async function analyzeTimelineEvent(params) {
  ...
  const messages = buildPromptMessages({
    ...
    contextLines: [
      ...
      'rawReply must use exactly three headings. IMPORTANT: each section MUST contain 2-4 specific, concrete, actionable sentences — DO NOT write just one short sentence. for example, 小咪觉得可以这样 should give 2-3 concrete next-step suggestions, not just one vague idea. Use Chinese colon：after each heading:\n小咪觉得对方可能在想：<content>\n小咪觉得可以这样：<content>\n小咪说留个心眼：<content>',
