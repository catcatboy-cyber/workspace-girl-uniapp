...
Output exactly 6 separate animation frames arranged left-to-right in one single row. Each frame must show the same pet: A small friendly puppy with floppy ears, round face, tiny paws, wagging tail, warm tan-and-cream markings, compact chibi proportions, expressive dark eyes, no collar text or logos..
