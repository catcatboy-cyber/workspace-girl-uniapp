...
.bs-sheet { width: 100%; max-height: 88vh; overflow-y: auto; padding: 0 0 calc(140rpx + env(safe-area-inset-bottom)); background: var(--app-bg, #FFFDF5); border-radius: 24rpx 24rpx 0 0; border-top: 3rpx solid var(--border, #111); box-shadow: var(--shadow-hero, 0 -8rpx 0 #111); animation: bs-slide-up 0.3s ease-out; box-sizing: border-box; }
...
.bs-topbar-close { width: 56rpx; height: 56rpx; border-radius: 50%; border: 2rpx solid var(--border, #111); display: flex; align-items: center; justify-content: center; font-size: 38rpx; color: var(--text-muted, #666); }
...
/* ═══ BAR CARDS ═══ */
.bs-card { border-radius: var(--shape-radius-card, 0); padding: 20rpx 24rpx; border: 2rpx solid #111; box-shadow: 4rpx 4rpx 0 #111; margin-bottom: 12rpx; background: linear-gradient(160deg, #E0FFF0 0%, #C8F0E0 100%); }
...
.bs-bar-sep { width: 3rpx; height: 100%; background: #111; flex-shrink: 0; }
