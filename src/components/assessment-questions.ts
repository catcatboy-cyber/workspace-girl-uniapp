...
export const questionDefinitions: any[] = [
  ...
  { id: 'Q5', title: '通常是谁先发起联系？', type: 'single_select', required: true, order: 4,
    options: [
  ...
  { id: 'Q7', title: '对方回复通常是什么状态？', type: 'single_select', required: true, order: 5,
    options: [
  ...
  { id: 'Q10', title: '对方是否会把你带入未来一点点的安排或设想中？', type: 'single_select', required: true, order: 7,
    options: [
  ...
  { id: 'Q12', title: '如果你停止主动几天，对方通常会怎样？', type: 'single_select', required: true, order: 8,
    options: [
  ...
  { id: 'Q13', title: '对方前后说法会明显不一致吗？', type: 'single_select', required: true, order: 9,
    options: [
  ...
  { id: 'Q14', title: '答应你的事情，对方兑现情况如何？', type: 'single_select', required: true, order: 10,
    options: [
  ...
  { id: 'Q15', title: '当你问到关键问题时，对方通常会？', type: 'single_select', required: true, order: 11,
    options: [
  ...
  { id: 'Q17', title: '对方对你的态度是否忽冷忽热？', type: 'single_select', required: true, order: 12,
    options: [
  ...
  { id: 'Q20', title: '你觉得自己现在掌握的是：', type: 'single_select', required: true, order: 13,
    options: [
  ...
  { id: 'QC', title: '对方是否有过暧昧或让你觉得"不止是朋友"的暗示？',
    type: 'single_select', required: true, order: 14,
    options: [
      { value: 'none', label: '没有' },
