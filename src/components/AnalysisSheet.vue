...
.as-sheet { width: 100%; max-height: 88vh; overflow-y: auto; padding: 0 0 calc(140rpx + env(safe-area-inset-bottom)); background: var(--app-bg, #FFFDF5); border-radius: 24rpx 24rpx 0 0; border-top: 3rpx solid var(--border, #111); box-shadow: var(--shadow-hero, 0 -8rpx 0 #111); animation: as-slide-up 0.3s ease-out; box-sizing: border-box; }
...
.as-share-btn { width: 56rpx; height: 56rpx; border-radius: 50%; border: 2rpx solid var(--border, #111); background: var(--surface, #fff); display: flex; align-items: center; justify-content: center; padding: 0; line-height: 1; }
.as-share-icon { width: 26rpx; height: 26rpx; }
.as-topbar-close { width: 56rpx; height: 56rpx; border-radius: 50%; border: 2rpx solid var(--border, #111); display: flex; align-items: center; justify-content: center; font-size: 38rpx; color: var(--text-muted, #666); }
...
/* ═══ STATE CARDS ═══ */
.as-state-card { display: flex; flex-direction: column; align-items: center; gap: 12rpx; padding: 60rpx 20rpx; border: 3rpx solid var(--border, #111); border-radius: var(--shape-radius-card, 0); box-shadow: var(--shadow-hard, 4rpx 4rpx 0 #111); background: var(--surface, #fff); }
.as-state-pending { background: var(--surface-dim, #f5f5f5); box-shadow: none; }
.as-state-error { background: #f5f5f5; border-color: #999; box-shadow: none; }
.as-state-emoji { font-size: 64rpx; }
.as-state-text { font-size: 28rpx; font-weight: 700; color: var(--text-main, #111); }

/* ═══ SIGNAL TAG ═══ */
.as-signal-tag { display: inline-block; padding: 8rpx 20rpx; margin-bottom: 12rpx; border-radius: 999rpx; border: 2rpx solid var(--border, #111); background: #fff; font-size: 24rpx; font-weight: 800; color: var(--text-main, #111); }

/* ═══ CONTENT CARDS ═══ */
.as-card { border-radius: var(--shape-radius-card, 0); padding: 24rpx 28rpx; border: 2rpx solid #111; box-shadow: 4rpx 4rpx 0 #111; margin-bottom: 16rpx; display: flex; flex-direction: column; gap: 8rpx; }
.as-card-kicker { font-size: 28rpx; font-weight: 700; color: var(--card-accent, #111); }
.as-card-sub { font-size: 22rpx; color: var(--text-muted, #666); }

/* intent card */
.as-card-intent { background: linear-gradient(160deg, #E0FFF0 0%, #C8F0E0 100%); --card-accent: #1a6b5a; }
.as-card-risk { background: linear-gradient(160deg, #FFEEEC 0%, #FFD8D4 100%); --card-accent: var(--risk, #FF5252); }
.as-card-reason { background: linear-gradient(160deg, #FFFBEA 0%, #FFF3D0 100%); --card-accent: #b8860b; }
.as-card-action { background: linear-gradient(160deg, #FFF8E0 0%, #FFE8B0 100%); --card-accent: #b8860b; }

/* score row */
.as-score-row { display: flex; align-items: baseline; gap: 8rpx; }
...
.as-action-label { font-size: 24rpx; font-weight: 700; color: var(--accent, #FFD93D); background: #111; padding: 2rpx 10rpx; border-radius: 4rpx; margin-right: 8rpx; }
