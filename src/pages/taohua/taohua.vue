...
.dir-cell-v2 { flex: 1; text-align: center; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface-dim, #f9f9f9); padding: 10rpx 4rpx; }
...
/* info popup */
.info-dot-v2 { display: inline-flex; align-items: center; justify-content: center; width: 36rpx; height: 36rpx; border: var(--border-width, 2rpx) solid var(--border, #111); font-size: $fs-caption; font-weight: 900; color: var(--text-main, #111); margin-left: auto; cursor: pointer; }
...
.info-sheet { width: 100%; max-width: 500px; max-height: 70vh; background: var(--app-bg, #FFFDF5); border: var(--border-width-strong, 3px) solid var(--border, #111); box-shadow: var(--shadow-hero, 8rpx 8rpx 0 #111); display: flex; flex-direction: column; overflow: hidden; }
...
.guide-dir-hl { display: inline-block; background: var(--accent, #FFD93D); padding: 2rpx 10rpx; font-weight: 900; }
...
.persona-share-action-v2 { width: 56rpx; height: 56rpx; border: var(--border-width-strong, 3rpx) solid var(--border, #111); background: var(--brand-warm, #FFFBEA); display: flex; align-items: center; justify-content: center; box-sizing: border-box; }
.mini-action-v2 { min-width: 104rpx; height: 48rpx; padding: 0 16rpx; border: var(--border-width-strong, 3rpx) solid var(--border, #111); background: var(--surface, #fff); color: var(--text-main, #111); display: flex; align-items: center; justify-content: center; font-size: $fs-caption; font-weight: 900; box-sizing: border-box; }
...
.persona-type-badge-v2 { display: inline-flex; align-items: center; max-width: 100%; min-height: 42rpx; padding: 0 14rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--accent, #FFD93D); font-size: $fs-caption; font-weight: var(--font-weight-hero, $fw-hero); color: var(--text-main, #111); line-height: 1; box-sizing: border-box; }
...
.persona-identity-item-v2 { min-width: 0; min-height: 76rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--brand-warm, #FFFBEA); display: flex; align-items: center; gap: 10rpx; padding: 10rpx; box-sizing: border-box; }
...
.persona-match-strip-v2 { display: grid; grid-template-columns: auto minmax(0, 1fr); gap: 14rpx; align-items: center; border: var(--border-width, 2rpx) dashed var(--border, #111); background: var(--surface, #fff); padding: 14rpx; margin-top: 14rpx; margin-bottom: 18rpx; }
.persona-match-badge-v2 { display: inline-flex; align-items: center; justify-content: center; min-height: 44rpx; padding: 0 14rpx; font-size: $fs-caption; font-weight: var(--font-weight-hero, $fw-hero); color: var(--text-main, #111); background: var(--surface, #fff); box-sizing: border-box; white-space: nowrap; }
...
.persona-dim-v2 { border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface, #fff); padding: 16rpx; margin-bottom: 14rpx; box-sizing: border-box; }
.persona-dim-label-v2 { display: inline-flex; align-items: center; background: var(--hero-tag-bg, #111); color: var(--hero-tag-color, #FFD93D); font-size: $fs-caption; font-weight: var(--font-weight-hero, $fw-hero); padding: 4rpx 12rpx; margin-bottom: 10rpx; line-height: $lh-label; }
...
.pair-party-card-v2 { min-width: 0; border: var(--border-width, 2rpx) dashed var(--border, #111); background: var(--app-bg, #FFFDF5); padding: 8rpx; display: flex; flex-direction: column; gap: 8rpx; box-sizing: border-box; }
.pair-relation-stack-v2 { min-width: 0; display: flex; flex-direction: column; gap: 8rpx; }
.pair-token-picker-v2 { width: 100%; min-width: 0; }
.pair-token-v2 { min-width: 0; width: 100%; min-height: 66rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--accent, #FFD93D); display: flex; align-items: center; justify-content: center; gap: 6rpx; padding: 0 8rpx; box-sizing: border-box; }
...
.pair-token-edit-v2 { position: absolute; right: 6rpx; top: 6rpx; width: 28rpx; height: 28rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface, #fff); display: flex; align-items: center; justify-content: center; box-sizing: border-box; }
...
.pair-preview-note-v2 { display: block; margin-top: 10rpx; padding: 12rpx 14rpx; border: var(--border-width, 2rpx) dashed var(--border, #111); background: var(--surface, #fff); font-size: $fs-caption; font-weight: $fw-label; color: var(--text-muted, #666); line-height: 1.45; }
...
.ov-row-v2.current { background: var(--brand-warm, #FFFBEB); margin: 0 -8rpx; padding: 12rpx 8rpx; border-radius: 4rpx; }
.ov-label-v2 { width: 130rpx; font-size: $fs-caption; font-weight: 900; color: var(--text-main, #111); flex-shrink: 0; }
.ov-dir-v2 { font-size: $fs-caption; font-weight: 600; color: var(--text-muted, #666); padding: 4rpx 12rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface-dim, #f9f9f9); margin: 0 4rpx; }
.ov-dir-v2.current { background: var(--accent, #FFD93D); color: var(--text-main, #111); font-weight: 800; }

/* 按钮 */
.btn-v2-me { display: flex; align-items: center; justify-content: center; height: 64rpx; border: var(--border-width-strong, 3rpx) solid var(--border, #111); font-size: $fs-body-lg; font-weight: var(--font-weight-heading, $fw-heading); background: var(--surface, #fff); color: var(--text-main, #111); border-radius: 0; }
...
.sheet-panel { width: 100%; max-width: 500rpx; background: var(--app-bg, #FFFDF5); border: var(--border-width-strong, 3rpx) solid var(--border, #111); box-shadow: var(--shadow-hero, 8rpx 8rpx 0 #111); border-radius: 16rpx 16rpx 0 0; padding: 28rpx 24rpx 60rpx; max-height: 70vh; overflow-y: auto; }
...
.picker-card-v2 { width: 100%; min-height: 92rpx; border: var(--border-width-strong, 3rpx) solid var(--border, #111); background: var(--surface, #fff); padding: 14rpx 16rpx; display: flex; align-items: center; justify-content: space-between; gap: 12rpx; box-sizing: border-box; }
...
.picker-action-v2 { flex-shrink: 0; width: 48rpx; height: 44rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--brand-warm, #FFFBEA); display: flex; align-items: center; justify-content: center; padding: 0; color: var(--text-main, #111); box-sizing: border-box; }
.sheet-actions-v2 { display: flex; gap: 12rpx; margin-top: 18rpx; }
.share-preview-image-v2 { width: 100%; border: var(--border-width-strong, 3rpx) solid var(--border, #111); box-sizing: border-box; }
...
.score-track-v2 { height: 14rpx; background: var(--surface-dim, #e8e8e8); border: var(--border-width, 2rpx) solid var(--border, #111); }
...
.action-boost-v2 { display: inline-flex; align-items: center; gap: 6rpx; margin-top: 12rpx; padding: 6rpx 14rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--risk, #FF5252); color: var(--surface, #fff); font-size: $fs-caption; font-weight: var(--font-weight-heading, $fw-heading); box-sizing: border-box; }
...
.action-dir-card-v2 { min-width: 0; padding: 14rpx 8rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface, #fff); text-align: center; box-sizing: border-box; }
...
.action-vibe-v2 { display: flex; align-items: center; gap: 10rpx; margin-top: 12rpx; padding: 12rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--surface, #fff); box-sizing: border-box; }
.action-vibe-label-v2 { flex-shrink: 0; padding: 4rpx 10rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--accent-cool, #4ECDC4); font-size: $fs-caption; font-weight: $fw-label; color: var(--text-main, #111); }
...
.action-guide-line-v2 { display: grid; grid-template-columns: 58rpx 1fr; gap: 10rpx; align-items: flex-start; padding: 12rpx; border: var(--border-width, 2rpx) solid transparent; background: var(--surface, #fff); box-sizing: border-box; }
...
.action-guide-pill-v2 { display: inline-flex; align-items: center; justify-content: center; min-height: 28rpx; border: var(--border-width, 2rpx) solid var(--border, #111); background: var(--accent, #FFD93D); font-size: $fs-caption; font-weight: $fw-label; color: var(--text-main, #111); }
...
/* 古籍出处 */
.cite-block-v2 { margin-top: 14rpx; padding: 10rpx 14rpx; background: var(--brand-warm, #FFFBEB); border-left: 4rpx solid var(--accent, #FFD93D); }
...
.action-box { margin-top: 12rpx; padding: 14rpx; border: var(--border-width, 2rpx) dashed var(--border, #111); background: var(--brand-cool, #f5f5ff); }
