...
.v2-mode .loading-v2 { text-align: center; padding: 120rpx 0; font-size: 26rpx; font-weight: 900; color: #111; letter-spacing: 4rpx; }
...
.v2-mode .section-sub-v2 { display: block; font-size: 20rpx; font-weight: 600; color: #666; line-height: 1.5; }
.v2-mode .refresh-text-v2 { display: block; margin-top: 12rpx; font-size: 20rpx; font-weight: 700; color: #999; }
...
.v2-mode .tag-v2.sm { padding: 4rpx 10rpx; font-size: 18rpx; }
...
.v2-mode .review-axis-v2 { width: 92rpx; flex-shrink: 0; display: flex; flex-direction: column; align-items: center; padding-top: 8rpx; color: #666; font-size: 18rpx; font-weight: 800; }
...
.v2-mode .review-title-v2 { flex: 1; font-size: 28rpx; font-weight: 900; color: #111; line-height: 1.3; }
.v2-mode .review-time-v2 { flex-shrink: 0; font-size: 18rpx; font-weight: 600; color: #999; }
.v2-mode .review-desc-v2 { display: block; margin-top: 12rpx; font-size: 24rpx; font-weight: 600; color: #555; line-height: 1.55; }
...
.v2-mode .ai-row-v2 { display: flex; align-items: center; gap: 12rpx; margin-top: 14rpx; font-size: 22rpx; font-weight: 700; color: #555; }
